...
window._load_script = function(url, callback, isSubmit) {
    ...
    var submitButton = document.querySelector('#_form_512_submit');
    ...
    script.onerror = function() {
        if (isSubmit) {
            if (script.src.length > 10000) {
                _show_error("512", "Sorry, your submission failed. Please shorten your responses and try again.");
            } else {
                _show_error("512", "Sorry, your submission failed. Please try again.");
            }
            submitButton.disabled = false;
            submitButton.classList.remove('processing');
        }
...
(function() {
    ...
    var _removed = false;
        var form_to_submit = document.getElementById('_form_512_');
    ...
    var form_submit = function(e) {
        ...
        if (validate_form()) {
            ...
            var submitButton = e.target.querySelector('#_form_512_submit');
            submitButton.disabled = true;
            submitButton.classList.add('processing');
                        var serialized = _form_serialize(
                document.getElementById('_form_512_')
            ).replace(/%0A/g, '\\n');
...
const observerPercentOne = new IntersectionObserver(entries => {
  ...
  entries.forEach(entry => {
    ...
    if (entry.isIntersecting) {
      ...
      counter("count1", 0, 65, 1500);
      counter("count2", 0, 23, 2500);
      counter("count3", 0, 13, 3000);
      counter("count4", 0, 16, 2500);
      counter("count5", 0, 41, 3000);
    }
  });
});
...
window._load_script = function(url, callback, isSubmit) {
  ...
  script.onerror = function() {
    if (isSubmit) {
      if (script.src.length > 10000) {
        _show_error("268", "Sorry, your submission failed. Please shorten your responses and try again.");
      } else {
        _show_error("268", "Sorry, your submission failed. Please try again.");
      }
    }
  }
