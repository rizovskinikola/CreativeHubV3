...
var typeString = " <strong>B</strong>,<strong>a</strong>,<strong>c</strong>,<strong>k</strong>,<strong>-</strong>,<strong>E</strong>,<strong>n</strong>,<strong>d</strong>, ,<span>><span>, ,A,c,а,d,e,m,y"
  ...
  script.onerror = function() {
    if (isSubmit) {
      if (script.src.length > 10000) {
        _show_error("400", "Sorry, your submission failed. Please shorten your responses and try again.");
      } else {
...
(function() {
  ...
  var form_submit = function(e) {
    ...
    if (validate_form()) {
      ...
      document.querySelector('#_form_400_submit').disabled = true;
            var serialized = _form_serialize(document.getElementById('_form_400_')).replace(/%0A/g, '\\n');
