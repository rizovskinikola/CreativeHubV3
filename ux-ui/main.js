...
//     var submitButton = document.querySelector('#_form_494_submit');
...
//                 _show_error("494", "Sorry, your submission failed. Please shorten your responses and try again.");
//             } else {
//                 _show_error("494", "Sorry, your submission failed. Please try again.");
//             }
//             submitButton.disabled = false;
//             submitButton.classList.remove('processing');
//         }
...
//     }
//     var _removed = false;
//         var form_to_submit = document.getElementById('_form_494_');
...
//             var submitButton = e.target.querySelector('#_form_494_submit');
//             submitButton.disabled = true;
//             submitButton.classList.add('processing');
//                         var serialized = _form_serialize(
//                 document.getElementById('_form_494_')
//             ).replace(/%0A/g, '\\n');
...
const configStories = {
  ...
  nav: true,
  startAt: 0, // Set the second slide as active (index 1)
  breakpoints: {
    1440: { perView: 3 },
    700: { perView: 1 }
  }
}
new Glide('.glide-stories', configStories).mount()
...
new Glide('.glide-behance', configBehance).mount()
...
const observerPercentOne = new IntersectionObserver(entries => {
  ...
  entries.forEach(entry => {
    ...
    if (entry.isIntersecting) {
      ...
      counter("count1", 0, 40, 1500);
      counter("count2", 0, 32, 2500);
      counter("count3", 0, 13, 3000);
      counter("count4", 0, 15, 2500);
    }
  });
});
...
const observerPercentTwo = new IntersectionObserver(entries => {
  ...
  entries.forEach(entry => {
    ...
    if (entry.isIntersecting) {
      ...
      counter("count5", 0, 60, 2000);
      counter("count6", 0, 24, 2500);
      counter("count7", 0, 6, 3000);
      counter("count8", 0, 10, 3000);
    }
  });
});
...
new Glide('.client-feedback', configClients).mount()
// const configStory = {
//   type: 'carousel',
//   perView: 1,
//   animationDuration: 2500,
//   nav: true,
// }
// new Glide('.glide-story', configStory).mount()
...
//   }
//   var _removed = false;
//   var form_to_submit = document.getElementById('_form_386_');
//   var allInputs = form_to_submit.querySelectorAll('input, select, textarea'), tooltips = [], submitted = false;
...
//     if (validate_form()) {
//       // use this trick to get the submit button & disable it using plain javascript
//       document.querySelector('#_form_386_submit').disabled = true;
//             var serialized = _form_serialize(document.getElementById('_form_386_')).replace(/%0A/g, '\\n');
//       var err = form_to_submit.querySelector('._form_error');
//       err ? err.parentNode.removeChild(err) : false;
...
(function () {
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      // use this trick to get the submit button & disable it using plain javascript
      document.querySelector('#_form_408_submit').disabled = true;
      var serialized = _form_serialize(document.getElementById('_form_408_')).replace(/%0A/g, '\\n');
      var err = form_to_submit.querySelector('._form_error');
      err ? err.parentNode.removeChild(err) : false;
      _load_script('https://akoskarova.activehosted.com/proc.php?' + serialized + '&jsonp=true', null, true);
      window.location.href = "https://creativehub.mk/thank-you/"
    }
    return false;
  };
  addEvent(form_to_submit, 'submit', form_submit);
})();
const configOurStudents = {
  type: 'carousel',
  perView: 3.2,
  animationDuration: 2500,
  nav: false,
...
new Glide('.glide-our-students', configOurStudents).mount()
...
const observer3 = new IntersectionObserver(entries => {
  ...
  entries.forEach(entry => {
    ...
    if (entry.isIntersecting) {
      ...
      counter("count11", 0, 50, 3500);
      counter("count22", 0, 20, 1500);
      counter("count33", 0, 30, 2500);
    }
  });
});
