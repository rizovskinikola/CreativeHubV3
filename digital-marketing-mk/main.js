...
//     var submitButton = document.querySelector('#_form_492_submit');
...
//                 _show_error("492", "Sorry, your submission failed. Please shorten your responses and try again.");
//             } else {
//                 _show_error("492", "Sorry, your submission failed. Please try again.");
//             }
//             submitButton.disabled = false;
//             submitButton.classList.remove('processing');
//         }
...
//     }
//     var _removed = false;
//         var form_to_submit = document.getElementById('_form_492_');
...
//             var submitButton = e.target.querySelector('#_form_492_submit');
//             submitButton.disabled = true;
//             submitButton.classList.add('processing');
//                         var serialized = _form_serialize(
//                 document.getElementById('_form_492_')
//             ).replace(/%0A/g, '\\n');
...
//       var serialized = _form_serialize(document.getElementById('_form_199_')).replace(/%0A/g, '\\n');
//       var err = form_to_submit.querySelector('._form_error');
//       err ? err.parentNode.removeChild(err) : false;
...
const observer2 = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    if (entry.isIntersecting) {
      ...
      counter("count5", 0, 62, 5000);
      counter("count6", 0, 21, 4000);
      counter("count7", 0, 12, 3000);
