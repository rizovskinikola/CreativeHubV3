...
window._load_script = function(url, callback, isSubmit) {
    ...
    var submitButton = document.querySelector('#_form_508_submit');
    ...
    script.onerror = function() {
        if (isSubmit) {
            if (script.src.length > 10000) {
                _show_error("508", "Sorry, your submission failed. Please shorten your responses and try again.");
            } else {
                _show_error("508", "Sorry, your submission failed. Please try again.");
            }
            submitButton.disabled = false;
            submitButton.classList.remove('processing');
        }
...
(function() {
    ...
    var form_submit = function(e) {
        ...
        if (validate_form()) {
            ...
            var submitButton = e.target.querySelector('#_form_508_submit');
            submitButton.disabled = true;
            submitButton.classList.add('processing');
                        var serialized = _form_serialize(
                document.getElementById('_form_508_')
            ).replace(/%0A/g, '\\n');
